...
const question = {
  ...
  ans: "c",
  explain: "Credit reports include personal information such as the individual's current and previous addresses, Social Security numbers, and employment history. These reports also include a credit history summary such as the number and type of bank or credit card accounts that are past due or in good standing, and detailed account information related to high balances, credit limits, and the date accounts were opened. 1000 Rs have been added to your account",
  wrongText: "Credit reports include personal information such as the individual's current and previous addresses, Social Security numbers, and employment history. These reports also include a credit history summary such as the number and type of bank or credit card accounts that are past due or in good standing, and detailed account information related to high balances, credit limits, and the date accounts were opened."
}
