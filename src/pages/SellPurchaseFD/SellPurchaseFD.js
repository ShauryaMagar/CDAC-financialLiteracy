...
const SellPurchaseFD = () => {
  ...
  const buyFD = (e) => {
    ...
    if (amt - bFD < 1000) {
      ...
      alert("Fixed Deposit Worth Rs."+bFD+" purchased !")
      var obj12 = passbook;
      var obj = {
  ...
  const sellFD = () => {
    var obj12 = passbook;
    var am = fd - (fd * 10) / 100;
    alert("FD sold before maturity, you recieved Rs."+am+" !")
    var obj = {
  ...
  return (
    <div className="spfd-back">
      ...
      <div
        className="container  spfd-content "
        style={{
          marginTop: "2rem",
          borderRadius: "15px",
          ...
          <div className="col-5">
            ...
            {fd !== 0 ? (
              <>
                ...
                <p>
                  Money to be received after maturity: {fd + (fd * 15) / 100}
                </p>
                <p>
                  Money to be received before maturity: {fd - (fd * 10) / 100}
                </p>
              </>
            ) : (
              ""
