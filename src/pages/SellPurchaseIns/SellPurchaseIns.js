...
const SellPurchaseIns = () => {
  ...
  useEffect(() => {
    ...
    window.scrollTo(0, 0);
    setAmt(
      parseInt(retrievedObj.moneyInHand[retrievedObj.moneyInHand.length - 1])
    );
  ...
  return (
    <div className="spins-back">
      <div className="container spins-content">
        ...
        >
          <div className="col-10" style={{ textAlign: "center" }}>
            <h1 style={{ fontFamily: "Poppins", fontWeight: "700" }}>
              Purchase/Sell Insurance
            </h1>
          </div>
        </div>
        <div className="row justify-content-between">
          <div className="col-2">
            <button onClick={backPage} className="btn btn-danger">
              Back
            </button>
          </div>
          <div
        ...
        >
          <div className="col-10" style={{ textAlign: "center" }}>
            <p style={{fontWeight:'800'}}>
              Selling Price of Insurance is lower as compared to the price it is
              purchased at.
            </p>
          </div>
        </div>
        <div
          className="row justify-content-center health-ins-card"
          style={{ marginTop: "1rem" }}
        >
          <div className="col-5">
        ...
        <div
          className="row justify-content-center house-ins-card"
          style={{ marginTop: "1rem" }}
        >
          <div className="col-5">
        ...
        <div
          className="row justify-content-center vehicle-ins-card"
          style={{ marginTop: "1rem" }}
        >
          <div className="col-5">
